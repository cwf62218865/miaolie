	...
	if (checksubmit('submit')) {
		...
		if(empty($answerid)){
			...
			if(pdo_insert('weliam_shifcar_question',$data)){
				message('创建成功',web_url('pc/help/answer_list'),'success');
			}else{
				message('创建失败',web_url('pc/help/answer_list'),'error');
			}
		}else{
...
if($op == 'answer_delete'){
	...
	if(pdo_delete('weliam_shifcar_question',array('uniacid'=>$_W['uniacid'],'id'=>$answerid))){
		message('删除成功',web_url('pc/help/answer_list'),'success');
	}else{
		message('删除失败',web_url('pc/help/answer_list'),'error');
	}
}
	...
	if (checksubmit('submit')) {
		...
		if(empty($categoryid)){
			if(pdo_insert('weliam_shifcar_category',$data)){
				...
				message('新分类创建失败！',web_url('pc/help/category_list'),'error');
			}
		}else{
