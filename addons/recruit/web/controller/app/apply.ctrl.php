...
$ops = array('list','send','output','cover','setting','import','delete');
...
if ($op == 'list') {
	...
	$orderstatus = array('1' => array('css' => 'info', 'name' => '待发货'), '2' => array('css' => 'warning', 'name' => '已发货'), '3' => array('css' => 'success', 'name' => '已收货'),  '4' => array('css' => 'default', 'name' => '已取消'));
