...
function forget_password(){
    ...
    $("body").on("click",".tel_con .click",function(){
        ...
        $.ajax({
            url:"/web/index.php?c=site&a=entry&m=recruit&do=member&ac=login&op=send_code&style=tel",
            type:"post",
            data:{
                tel:$("#tel_number").val()
            },
    ...
    $("body").on("click",".email_con .click",function(){
        ...
        $.ajax({
            url:"/web/index.php?c=site&a=entry&m=recruit&do=member&ac=login&op=send_code&style=email",
            type:"post",
            data:{
