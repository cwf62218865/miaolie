					...
					angular.forEach(val, function(newsVal, newsKey) {
						...
						if (index == -1) {
							$('.keywords-list').append(
								...
								'	</div>'+
								'	<div class="opr">'+
										(newsVal.attach_id ? '<a href="./index.php?c=platform&a=material-post&type=reply&newsid='+(newsVal.attach_id ? newsVal.attach_id : '')+'&reply_news_id='+newsVal.id+'" target="_blank" class="del-gray">编辑</a>' : '') +
