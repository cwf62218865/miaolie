		...
		<table class="table table-hover">
			...
			<?php  if(is_array($list)) { foreach($list as $li) { ?>
				<tr>
					...
					<td><?php  echo $li['jobs_name']?></td>
					<td><?php  echo $li['companyname']?></td>
					<td><?php  echo $li['wage_min']?>-<?php  echo $li['wage_max']?>k</td>
					<td><?php  echo $li['experience']?></td>
