        ...
        <div class="con_list">
            ...
            <div class="resume_header">
                <div class="resume_manage_header">
                    <span style="display: inline-block;position: absolute;left: 5px;top: 5px;width: 120px;height: 120px;border-radius: 60px;overflow: hidden"><img  src="<?php  if($resume['headimgurl']) { ?><?php  echo $resume['headimgurl']?><?php  } else { ?><?php echo WL_URL_ARES;?>images/resume_head.png<?php  } ?>">
                    </span>
                    <div class="img_con">
