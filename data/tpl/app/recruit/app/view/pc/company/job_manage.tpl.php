                ...
                <div class="list_item">
                    <div class="item_con">
                        <div class="hang1">
                            ...
                            <a class="salary"><?php  if(is_numeric($list['wage_min'])===true && is_numeric($list['wage_max'])===true) { ?><?php  echo $list['wage_min']?>-<?php  echo $list['wage_max']?>K<?php  } else { ?>面议<?php  } ?></a>
                        </div>
                        <div class="hang2">
                ...
                <div class="list_item">
                    <div class="item_con">
                        <div class="hang1" >
                            ...
                            <a class="salary" style="color: #999"><?php  if(is_numeric($list['wage_min'])===true && is_numeric($list['wage_max'])===true) { ?><?php  echo $list['wage_min']?>-<?php  echo $list['wage_max']?>K<?php  } else { ?>面议<?php  } ?></a>
                        </div>
                        <div class="hang2">
                            <a class="exptime nowrap" style="color: #666">工作地点：<?php  echo $list['city'].$list['city_erea'].$list['address']?></a>
                            <span class="date" style="color: #666"><?php  echo date('Y-m-d',$list['addtime'])?></span>
