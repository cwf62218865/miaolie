...
$.fromdata("#company_nomsgbox","<?php  echo app_url('company/company_profile/save_company_profile')?>","#save_company_nomsg",function(data){
    //do something
})
...
$(".modalbtn").on("click",function(){
    ...
    $.ajax({
        ...
        success:function (data) {
            ...
            if(data.status==1){
                //location = location;
                var html ="<div class=\"person_worksbtn\">\n" +
                ...
                $(".person_worksbtn1").before(html);
                $("#person_worksinput").val(data.content);
