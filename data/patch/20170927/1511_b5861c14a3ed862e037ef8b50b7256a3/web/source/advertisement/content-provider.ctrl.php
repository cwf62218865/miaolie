...
if ($do == 'register_flow') {
	...
	if (checksubmit('submit')) {
		...
		if (!empty($_FILES['id_card_photo']['tmp_name'])) {
			...
			$_W['uploadsetting']['images']['folder'] = '';
			$_W['uploadsetting']['images']['extentions'] = array('jpg');
			$_W['uploadsetting']['images']['limit'] = $_W['config']['upload']['images']['limit'];
			$upload = file_upload($_FILES['id_card_photo'], 'images', "id_card");
		...
		if (!empty($_FILES['business_licence_photo']['tmp_name'])) {
			...
			$_W['uploadsetting']['images']['extentions'] = array('jpg');
			$_W['uploadsetting']['images']['limit'] = $_W['config']['upload']['images']['limit'];
			$upload = file_upload($_FILES['business_licence_photo'], 'images', "business_licence");
